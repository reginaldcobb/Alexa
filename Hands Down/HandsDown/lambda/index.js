...
const welcomeMessage = `Welcome to the Hands Down Kanila Five Game !  You can play several quiz type games. Ask for help if you want to hear the game types available. What would you like to do?`;
// const startQuizMessage = `OK.  I will ask you 10 questions about the United States. `;
const startQuizMessage = `OK.  Let's start playing Hands Down Kanila Five. `;
// const exitSkillMessage = `Thank you for playing the United States Quiz Game!  Let's play again soon!`;
const exitSkillMessage = `Thank you for playing Hands Down Kanila Five!  I hope you play again soon!`;
// const repromptSpeech = `Which other state or capital would you like to know about?`;
const repromptSpeech = `This is the reprompt`;
...
const helpMessage = `Hands Down Kanila Five is a simple game.  <break time="0.5s"/>  First you pick a type of game.  You can play Multiple Choice <break time="0.5s"/>  Question and Answer  <break time="0.5s"/>   True False  <break time="0.5s"/>  Put Them in Order  <break time="0.5s"/>  Who Am I  <break time="0.5s"/>  Math Puzzles <break time="0.5s"/> .   What type game would you like to play?`;
